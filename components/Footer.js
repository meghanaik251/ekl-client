...
function Footer() {
  ...
  return (
    <div className="footer_container">
      <div className="about">
        <h5 className="titleA" style={{ color: "whitesmoke" }}>
          {aboutWidget?.title}{" "}
        </h5>
        <br></br>
        ...
        <div className="social_media_links">
          <br />
          {socialMediaLinkWidget?.content.map(
            (d, i) =>
              d.show && (
                <a
                  key={i}
      ...
      <div className="latest_news">
        <h5 className="titleA" style={{ color: "white" }}>
      ...
      <div className="website_tags">
        <h5 className="titleA" style={{ color: "white" }}>
          {websiteTagsWidget?.title}
        </h5>{" "}
        <br />
        {websiteTagsWidget?.content.map(
          (d, i) =>
            !d.show && (
              <button
                onClick={() => router.push(d.link)}
