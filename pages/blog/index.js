            ...
            >
              <div className="blog-container">
                ...
                <div className="blog-like-view-container row">
                  <div className="col fa fa-thumbs-o-up"> <FontAwesomeIcon icon={faThumbsUp} /> { blogInfo.likes}</div>
                  <div className="col fa fa-eye"> <FontAwesomeIcon icon={faEye} /> {blogInfo.views}</div>
                </div>
                </article>
              </div>
            </Link>
